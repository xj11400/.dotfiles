...
# Default options
export FZF_DEFAULT_OPTS='--bind=ctrl-j:accept,ctrl-k:kill-line' #ctrl-[:abort
export FZF_DEFAULT_OPTS="$FZF_DEFAULT_OPTS --color='hl:4,hl+:4'"
...
# zstyle ':fzf-tab:*' fzf-flags --color=hl:4,hl+:4 --bind=ctrl-j:accept #,ctrl-\[:abort
